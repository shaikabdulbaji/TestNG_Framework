package b31SeparatingDataProviderintoaseparateClassusingdataProviderClassattribute;
...
/*
 * If we move the "DataProvider" method to seperate class then the main test case will not run we 
   get exception to overcome this we use "dataProviderClass = bDataProvider.class" at tags level.
   bDataProvider is dataprovider class, dataProviderClass is attribute.
 */
