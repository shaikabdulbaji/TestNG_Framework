...
public class hRealTimeExampleForAssertFalse {
	...
	public void validCredentials()
	{
		...
		Assert.assertFalse(driver.findElement(By.xpath("//a[text()='Edit your account information']")).isDisplayed());
	...
	public void searchHP()
	{
		...
		Assert.assertFalse(driver.findElement(By.xpath("//a[text()='HP LP3065']")).isDisplayed());
	...
	public void searchHonda()
	{
		...
		Assert.assertFalse(driver.findElement(By.xpath("//h2[text()='Products meeting the search criteria']")).isDisplayed());
