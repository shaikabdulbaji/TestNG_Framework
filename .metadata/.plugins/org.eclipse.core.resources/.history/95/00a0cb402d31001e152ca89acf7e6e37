package b28TestNGParameterizationDataProviderannotationanddataProviderattribute;
...
/*
 * If we want to login into that tutorials nija site with 1 credentials it is okay but i want to
   login with 1000 credentials then we go for DataDriven testing.
 */
