package b41ControllingDataProviderparalleltestscountbyusingdataproviderthreadcount;
 ...
 * After parallel attribute the all tests will run in at a time and how many email id's we give that
   many browsers will open at a time and execute the tests but there is some problem while doing this
   if we have 100 email id's then that many browsers will open at a time and that will degrade our 
   performance or my system can't handle that many browsers and my network wil also not support
