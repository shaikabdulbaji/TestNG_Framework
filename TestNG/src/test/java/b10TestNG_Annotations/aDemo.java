...
/*
 * If all the tests got passed then browser will close, if one test will fail then browser will not close
   then we remove and put driver.quit() under "@AfterMethod" method.
 * amotooricap1@gmail.com 12345, amotooricap12@gmail.com 12345
 */
