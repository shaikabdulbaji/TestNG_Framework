package b71Takingscreenshots_forFailedTests_using_DependencyInjection;
...
import b71uBase.Base;
import io.github.bonigarcia.wdm.WebDriverManager;

public class aLogin extends Base {
		...
		{
			if(result.getStatus()==ITestResult.FAILURE) // result.getStatus() return true
			{
				String testName = result.getName();
				System.out.println(testName+" got failed ");
				takeScreenShot(driver,testName); // This method is from Base class
				// Don't forgot to extend Base class to this class
			}
