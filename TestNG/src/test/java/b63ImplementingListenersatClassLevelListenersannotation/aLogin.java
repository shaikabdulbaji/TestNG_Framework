package b63ImplementingListenersatClassLevelListenersannotation;
 ...
 * In next session we learn how to link that MyTestListeners at suite level, suite level means under
   ...
   because writing @Listeners(MyTestListeners.class) above each and every class is not a good 
   practice.
 */
