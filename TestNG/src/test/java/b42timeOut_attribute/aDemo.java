...
/*
 * Before "timeOut" attribute the test case was running with in 7 seconds but client
   want to run that test case in 6 seconds at that time we use "timeOut" attribute.
 */
